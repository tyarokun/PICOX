...
OBJS := boot2.o handler.o vector_table.o serial.o main.o clock.o interrupt.o kernel.o syscall.o lib.o memory.o shell.o consdrv.o app.o sddrv.o spi.o elf_loader.o fat32.o
